# freshCVE
Server with RESTfull API to get CVEs from different sources.

Usage:
```
Usage of freshCVE.exe:
  -config string
...
Default config in [HashiCorp Configuration Language (HCL)](https://github.com/hashicorp/hcl)
```hcl
