...
//	expected := []Source{
//		Source{Description: "circle src", BaseURL: "http://cve.circl.lu/api/last/2", TypeName: "circl",
//			Type: SourceType{ID: "id", Published: "Published", References: "references", Description: "summary"},
//		},
//		Source{Description: "redhat src", BaseURL: "http://access.redhat.com/labs/securitydataapi/2018-05-28", TypeName: "redhat",
